...
export function Footer() {
	return (
		<footer className="relative flex flex-col items-center bg-(--footer-color) h-fit w-full">
			<a
				className="bg-[url(/maps/map.jpg)] h-62.5 w-full md:absolute md:right-10 md:top-10 lg:top-auto lg:bottom-12.5 md:size-[25vw] xl:size-112.5 md:rounded-[12px] bg-center bg-no-repeat"
			...
			<div className="flex flex-col md:flex-row pl-3.75 pt-4 pb-9.75 md:pb-15 mt-12 md:mt-0 md:pt-10 md:px-10 w-full">
				<div className="flex md:flex-col justify-between items-center md:items-start w-full md:max-w-40">
				...
				<div className="flex flex-col gap-7 lg:gap-10 md:w-full md:ml-[5%] lg:ml-[15%]">
