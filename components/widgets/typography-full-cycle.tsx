...
export function TypographyFullCycle() {
  ...
  return (
    <div className="relative overflow-hidden w-full">
      ...
      <p className="w-full h-full mt-7 md:mt-8 lg:mt-9 xl:mt-10 mx-auto max-w-58 md:max-w-95 lg:max-w-180 xl:max-w-200 text-center text-sm md:text-lg lg:text-xl xl:text-[22px] font-medium leading-[140%] font-montserrat">
        {t("p.1")}
      ...
      <div className="z-1 absolute bg-contain yellow-animation translate-x-[-50%] bg-[url(/yellow-bg.svg)] top-0 left-1/2 size-60 md:size-70 lg:size-87" />
      <div className="z-1 absolute bg-contain pink-animation translate-x-[50%] bg-[url(/pink-bg.svg)] top-14.5 md:top-18.5 lg:top-24.5 right-0 md:right-7 lg:right-15 size-60.75 md:size-85 lg:size-111" />
      <div className="z-1 absolute bg-contain blue-animation translate-x-[-50%] bg-[url(/blue-bg.svg)] top-27.5 md:top-19 lg:top-12.5 size-61.5 md:size-100 lg:size-136" />
    </div>
  );
}
