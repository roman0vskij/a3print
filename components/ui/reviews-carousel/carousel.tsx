	...
	return (
		<>
			...
			<div className="max-lg:hidden min-h-50 w-screen max-w-[1440px] mt-15 overflow-hidden">
				...
				{/* <button className="swiper-button-prev1 z-5 absolute top-[50%] translate-y-[-50%] size-12 bg-(--primary-color) rounded-full" />
					<button className="swiper-button-next1 z-5 absolute top-[50%] translate-y-[-50%] right-0 size-12 bg-(--primary-color) rounded-full" /> */}
